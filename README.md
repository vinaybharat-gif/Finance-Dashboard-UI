...
**Live Demo:** [https://finance-dashboard-ui-alpha.vercel.app](https://finance-dashboard-ui-alpha.vercel.app)
...
### Transactions
* **Full transaction list:** View date, category, description, type, and amount
...
* *Note: Role switcher is available in the header for demonstration purposes.*
